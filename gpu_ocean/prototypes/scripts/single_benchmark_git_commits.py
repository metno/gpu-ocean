...
# Run index 2 on windows as:
# python single_benchmark_git_commits.py laptop\fbl_cuda_git_versions_laptop.csv 2
#       --run_benchmark_opt="--simulator=FBL --steps_per_download=100 --iterations=10"
#
# With openCL, add --python=python2
...
parser.add_argument('index', default=None, type=int, help='List index for git commit')
...
parser.add_argument('--list', default=False, action='store_true', help='print the list of git commits')
...
for index, row in df.iterrows():
    if index != chosen_index:
        continue
    print('Running index '+str(index)+', '+row['label'])
