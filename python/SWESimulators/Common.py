...
This python module implements utility classes for holding buffers
for numerical schemes for solving the shallow water equations. It 
also contains classes for representing wind stress, bathymetry and 
boundary conditions.
