...
void reconstructSlopeX(__local float  Q[3][block_height+4][block_width+4],
...
void reconstructSlopeY(__local float  Q[3][block_height+4][block_width+4],
