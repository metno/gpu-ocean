"""
gitFilterIpynbAnimations.py

Tailored for the GPU-Ocean repository

Inspired by https://stackoverflow.com/questions/18734739/using-ipython-notebooks-under-version-control/20844506

Effect:

This filter is run before staging files to commit in git and clears the notebook output 
if the output is of type 'text/html' like animations
